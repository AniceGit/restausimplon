...
from app.core.security import create_access_token, create_refresh_token, verify_password, get_password_hash, ACCESS_TOKEN_EXPIRE_MINUTES
...
async def login_for_access_token(
    ...
    user = session.exec(Utilisateur).filter(Utilisateur.email == email).first()
